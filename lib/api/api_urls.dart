...
const serverApiAuthority = '192.168.1.76:8080';
const androidEmulatorAuthority = '10.0.2.2:8080'; // Android Emulator IP
const iosEmulatorAuthority = '127.0.0.1:8080'; // IOS Emulator IP
const sgLaptopApiAuthority = '10.0.1.50:8080';
const myLaptopApiAuthority = '10.0.2.2:8080';

const musicTrainerTestEndpoint = '/test-feign-client';
const getEbayAuthEndpoint = '/ebay/auth';
